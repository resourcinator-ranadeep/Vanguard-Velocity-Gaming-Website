...
import { Download, Play, Globe, Smartphone, Monitor, Github } from 'lucide-react';
  ...
  return (
    <section id="download" className="py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {platforms.map((platform, index) => (
            ...
            >
              ...
              <button className={`w-full bg-gradient-to-r ${platform.color} text-white py-3 px-6 rounded-lg font-bold transition-all duration-300 transform hover:scale-105 hover:shadow-xl`}>
        ...
        {/* Additional Info */}
        <div className="bg-gradient-to-r from-gray-800/30 to-gray-700/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8 text-center">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <Github className="w-8 h-8 text-gray-400" />
              <div className="text-left">
                <h4 className="text-lg font-bold text-white">Open Source</h4>
                <p className="text-gray-300">View the code on GitHub</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="bg-gradient-to-r from-sky-500 to-emerald-500 hover:from-sky-400 hover:to-emerald-400 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200">
                Report Issues
              </button>
            </div>
          </div>
