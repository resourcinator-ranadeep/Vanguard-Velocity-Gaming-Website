...
const Footer = () => {
  ...
  const [isHelpCenterDialogOpen, setIsHelpCenterDialogOpen] = useState(false);
  ...
  const footerLinks = [
    ...
    },
    {
      title: 'Support',
      links: [
        { text: 'Help Center', href: '#', onClick: () => setIsHelpCenterDialogOpen(true) },
        { text: 'Bug Reports', href: 'https://forms.gle/CDUTcSE6ZSeZKBmb9' },
        { text: 'Feature Requests', href: 'https://forms.gle/CDUTcSE6ZSeZKBmb9' },
        { text: 'Community', href: '#', onClick: () => setIsCommunityDialogOpen(true) }
      ]
    },
    {
      title: 'Legal',
  ...
  return (
    <>
                  ...
                  {section.links.map((link, linkIndex) => (
                    <li key={linkIndex}>
                      <a
                        ...
                        className="text-gray-400 hover:text-sky-400 transition-colors duration-200 cursor-pointer"
                      >
                        {link.text}
                      </a>
                    </li>
      ...
      <HelpCenterDialog 
        isOpen={isHelpCenterDialogOpen} 
        onClose={() => setIsHelpCenterDialogOpen(false)} 
      />
    </>
  );
};
